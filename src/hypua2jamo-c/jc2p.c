...
ptrdiff_t hypua_jc2p_ucs2_decode(const uint16_t *src, int srclen, uint16_t *dst) {
	int dstlen = 0;
	struct Decoder decoder;
...
ptrdiff_t hypua_jc2p_ucs4_decode(const uint32_t *src, int srclen, uint32_t *dst) {
	int dstlen = 0;
	struct Decoder decoder;
